...
public class FhcTripLoginStepDefinitions {
    ...
    public void user_enters_valid_username() {
        fhcTripLoginPage.username.sendKeys(ConfigurationReader.getProperty("valid_username"));
    }
    @Given("user enters  valid password")
    public void user_enters_valid_password() {
        fhcTripLoginPage.password.sendKeys(ConfigurationReader.getProperty("valid_password"));
    }
